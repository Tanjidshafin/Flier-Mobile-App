...
export function BookingSuccessScreen({ navigation, route }: Props) {
  ...
  const [booking, setBooking] = React.useState<BookingSummary | null>(
    latestBooking?.id === bookingId ? latestBooking : null,
  );
      ...
      <View className="rounded-[32px] bg-white p-5">
        ...
        <View className="mt-5 gap-3">
          ...
          <BookingInfoRow
            ...
            value={`${booking.guests.adults + booking.guests.children} guests, ${booking.guests.rooms} room`}
          />
